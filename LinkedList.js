...
class LinkedList {
  ...
  insertAtBeginning(data) {
    ...
    // As we are inserting at the beginning the head pointer needs to know point at the newNode.
  ...
  // A helper function getAt() is defined to get to the desired position. This function can also be later used for
  //performing delete operation from a given position.
  getAt(index) {
    let counter = 0;
    let node = this.head;
    while (node) {
